  ...
  return (
    <section id="section5" className={styles.section5}>
      ...
      <div className={styles.connectContainer}>
        <div className={styles.connectContent}>{userDetails.connectDesc}</div>
        <div className={styles.connectButtons}>
          {userDetails.email && <a href={`mailto:${userDetails.email}`} target='_blank' rel='noopener noreferrer'>
            <button>
          ...
          {userDetails.linkedin && <a href={userDetails.linkedin} target='_blank' rel='noopener noreferrer'>
            <button>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          {userDetails.github && <a href={userDetails.github} target='_blank' rel='noopener noreferrer'>
            <button>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
